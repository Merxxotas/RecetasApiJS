# Implementación de un proyecto de recopilacion de recetas, consumiendo una API de [The meal DB](https://themealdb.com/) aplicando el concepto de uso de Api en JS, y persistencia de datos con IndexedDB.
